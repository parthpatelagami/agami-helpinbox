    ...
    return (     
          <Card >
            <Grid container item sm={12} md={12} xs={12}>
              ...
              <Grid item className='pt-0' sm={12} md={9} xs={12}> 
                <CardContent className='py-0'>              
                  <Grid container item md={12} sm={12} xs={12} className='py-3.5 flex justify-start flex-col md:justify-between lg:justify-between md:flex-row lg:flex-row'>
                    ...
                    <Grid item md={5} sm={12} xs={12} className='w-auto flex items-center justify-end'>
                      <Tooltip placement='top' title='Create Jira Ticket'>                      
                        <IconButton className='border border-solid text-primary mr-1 rounded-full p-[5px]'>
                      ...
                      <Tooltip placement='top' title='Forward Ticket'>
                        <IconButton onClick={()=> setOpenForwardTicket(!openForwardTicket)} className='border border-solid text-primary mr-1 rounded-full p-[5px]'>
