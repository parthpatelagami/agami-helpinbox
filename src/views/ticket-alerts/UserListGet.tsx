          ...
          articles: [
            {
              ...
              content: `<p>We will only send you emails from @com. However, some people may receive fake or suspicious emails that look like they were sent by US. These emails might include malicious attachments or links to spam or phishing websites. Please know that we will never send emails with attachments or request your password by email.</p><p>We will only send you emails from @com. However, some people may receive fake or suspicious emails that look like they were sent by US. These emails might include malicious attachments or links to spam or phishing websites. Please know that we will never send emails with attachments or request your password by email.</p>`
            },
            {
          ...
          articles: [
            {
              ...
              content: `<p>We provide photo hosting for some image uploads (i.e., pic.com images) as well as account profile photos, and header photos. However, We are not the sole photo provider for images that may appear on the platform. More information about posting photos on platform.</p><p>We provide photo hosting for some image uploads (i.e., pic.com images) as well as account profile photos, and header photos. However, We are not the sole photo provider for images that may appear on the platform. More information about posting photos on platform.</p>`
            },
            {
...
const UserListGet = () => {
  ...
  const handleRedirection = (option:any) => {
    ...
    let currentSubcategory: any | null = null
  ...
  return (
      ...
      <Autocomplete
        ...
        sx={{
          '& + .MuiAutocomplete-popper .MuiAutocomplete-listbox': { maxHeight: 300 },
        }}
        ...
        renderOption={(props, option: any| unknown) => {
          return value.length ? (
            ...
            >
              <ListItemButton sx={{ py: 1.5 }}>{(option as any).name}</ListItemButton>
            </ListItem>
            </PerfectScrollbar>
          ) : null
        }}
