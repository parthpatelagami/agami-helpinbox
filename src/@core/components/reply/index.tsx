...
export const historydata = [
  {
    ...
    time: 'Mon Dec 10 2018 07:46:00 GMT+0000 (GMT)',
    statustitle:"Assinee Changed from Dhanshree Vartak to Kajal Sapkal.",
    avatar: '/images/avatars/1.png'
  },
  {
    id:2,
...
export const ticketFieldData = [
  {
    id:1,
    inputField:'INPUT',
    label:"ITR Registration Number",
    defaultValue:8998899833,
    optionValue:[]
  },
  {
    id:2,
